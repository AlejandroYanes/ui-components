...
export const icons = {
  ...
  ADD_BOOKMARK: BookmarkAddIcon,
  REMOVE_BOOKMARK: RemoveBookmarkIcon,
  ...
  FORWARD: ForwardIcon,
  SEND: SendIcon,
  MORE_VERT: MoreVrtIcon,
  FILTER: FilterIcon,
  FORM: FormIcon,
  COMMENTS: CommentsIcon,
  CREATE_PENCIL: CreatePenIcon,
  PENCIL: PencilIcon,
  EDIT_PENCIL: EditPenIcon,
  ...
  LAYERS: LayersIcon,
  GRID_ELEMENTS: GridElementsIcon,
  MAXIMIZE: MaximizeIcon,
  TIME_HISTORY: TimeHistoryIcon,
  LIST: ListIcon,
  TAG: TagIcon,
  GOOGLE: GoogleIcon,
  ...
  GLASS_MARTINI: GlassMartiniIcon,
  ...
  EAR: EarIcon,
  BABY_CARRIAGE: BabyCarriageIcon,
  CHECK_CIRCLE: CheckCircleIcon,
  EXCLAMATION_TRIANGLE: ExclamationTriangleIcon,
  EXCLAMATION_OCTAGON: ExclamationOctagonIcon,
  CHECK_SQUARE: CheckSquareIcon,
  BRAIN: BrainIcon,
  CURLY_BRACKETS: CurlyBracketsIcon,
  CIRCUIT: CircuitIcon,
  FILM: FilmIcon,
  SLIDERS_VERT: SlidersVertIcon,
